...
export function LandingHero() {
  return (
    <section className="relative overflow-hidden rounded-3xl border border-line bg-bg-elev px-8 py-16 shadow-[var(--shadow-card)] sm:px-16 sm:py-24">
      {/* Layered gradient orbs for depth */}
      <div
        aria-hidden
        className="absolute -right-40 -top-40 h-96 w-96 rounded-full opacity-40 blur-3xl"
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <motion.h1
          ...
          className="
            mt-6 font-display text-4xl font-bold tracking-tight text-fg
            sm:text-6xl
          "
        >
          An AI SRE that{" "}
